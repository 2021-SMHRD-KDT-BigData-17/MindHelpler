	...
	<div class="container">
		...
		<div class="main">
			...
			<div id="channel-finish" style="display: none">
				<img src="https://assets.trost.co.kr/images/service/emoji/happy.gif"
					id="finish-image" />
				...
				<button class="re" onclick="location.href = './survey.jsp'">
					검사 다시하기</button>
			</div>
		</div>
	</div>
	...
	<script>
		...
		const questionList = [ {
			...
			answers : [ {
				...
				text : "조금 흥미가 떨어진 것 같아요.",
				score : 1
			}, {
				text : "음식에 대한 흥미가 많이 줄었어요.",
				score : 2
			}, {
				text : "음식에 대한 흥미가 전혀 없어요.",
				score : 3
			}, ],
		}, {
			...
			answers : [ {
				...
				text : "가끔 그런 생각이 들기도 해요.",
				score : 1
			}, {
				text : "자주 자살에 대한 생각이 들어요.",
				score : 2
			}, {
				text : "항상 자살에 대한 생각이 들어요.",
				score : 3
			}, ],
		}, {
			...
			answers : [ {
				...
				text : "때때로 스트레스에 영향을 받을 때도 있어요.",
				score : 1
			}, {
				text : "상당히 쉽게 스트레스에 영향을 받아요.",
				score : 2
			}, {
				text : "항상 스트레스에 쉽게 영향을 받아요.",
				score : 3
			}, ],
		}, {
			question : "자신을 가치 없다고 생각하나요?",
			answers : [ {
				text : "전혀 그렇게 생각하지 않아요.",
				score : 0
			}, {
				text : "가끔 자신을 가치 없다고 생각하기도 해요.",
				score : 1
			}, {
				text : "자주 자신을 가치 없다고 생각해요.",
				score : 2
			}, {
				text : "항상 자신을 가치 없다고 생각해요.",
				score : 3
			}, ],
		}, {
			question : "사회적 활동에 관심이 없나요?",
			answers : [ {
				text : "사회적 활동에 큰 관심이 있어요.",
				score : 0
			}, {
				text : "때때로 관심이 없는 순간이 있어요.",
				score : 1
			}, {
				text : "사회적 활동에 대한 관심이 줄었어요.",
				score : 2
			}, {
				text : "사회적 활동에 전혀 관심이 없어요.",
				score : 3
			}, ],
		}, {
			...
			answers : [ {
				...
				text : "때때로 피곤한 기분이 들기도 해요.",
				score : 1
			}, {
				text : "상당히 피곤한 기분이 지속돼요.",
				score : 2
			}, {
				text : "항상 피곤한 기분이에요.",
				score : 3
			...
			answers : [ {
				text : "긍정적인 감정을 자주 느껴요.",
				score : 0
			}, {
				text : "때때로 긍정적인 감정을 느끼기 어려울 때도 있어요.",
				score : 1,
			}, {
				text : "상당히 긍정적인 감정을 느끼기 어려워요.",
				score : 2
			}, {
				text : "전혀 긍정적인 감정을 느끼지 못해요.",
				score : 3
			}, ],
		}, {
			question : "자신에게 대한 자신감이 부족한가요?",
			answers : [ {
				text : "자신에게 대한 자신감이 충분해요.",
				score : 0
			}, {
				text : "때때로 자신에게 대한 자신감이 부족할 때도 있어요.",
				score : 1,
			}, {
				text : "상당히 자신에게 대한 자신감이 부족해요.",
				score : 2
			}, {
				text : "전혀 자신에게 대한 자신감이 없어요.",
				score : 3
			}, ],
		}, {
			question : "다른 사람들과 대화하기 힘들나요?",
			answers : [ {
				text : "다른 사람들과 대화하는 데 문제가 없어요.",
				score : 0
			}, {
				text : " 때때로 다른 사람들과 대화하기 힘들 때도 있어요.",
				score : 1,
			}, {
				text : "자주 다른 사람들과 대화하기 힘들어요.",
				score : 2
			}, {
				text : "전혀 다른 사람들과 대화하기 힘들어요.",
				score : 3
			}, ],
		}, {
			...
			answers : [ {
				...
				text : "조금요, 2kg 가량 줄었어요.",
				score : 1
			}, {
				text : "많이요, 4kg 가량 줄었어요.",
				score : 2
			}, {
				text : "너무 급격하게 많이 줄었어요.",
				score : 3
			}, ],
		}, {
		...
		const scoreRanges = [
				{
					...
					maxScore : 10,
					status : "우울하지 않은 상태",
					message : "우울한 게 뭐죠?!<br> 와우! 축하해요! <br>당신은 보기 드물게<strong> ‘전혀 우울하지 않은’ </strong>사람!! :D",
				},
				{
					minScore : 11,
					maxScore : 15,
					status : "가벼운 우울 상태",
					message : "나도 모르게 요즘 좀 우울... 전혀 우울하지 않은~<br>약간 우울한~ 상당히 우울한~<br>심각하게 우울한 상태 중에서 당신은 <strong>‘약간 우울한 상태’예요.</strong>  <br>혹시 조금씩 지쳐가는 요즘, 이 정도는 별일 아니라며 그냥 지나치고 있나요?",
				},
				{
					minScore : 16,
					maxScore : 23,
					status : "중한 우울 상태",
					message : "괜찮은 듯 그러나 괜찮지 않은... 전혀 우울하지 않은~<br>약간 우울한~상당히 우울한~<br>심각하게 우울한 상태 중에서 당신은 <strong>‘상당히 우울한 상태’</strong>입니다.<br> 혹시 공허하거나 무기력하고 혼자 이런 감정을 해결하기 어렵다면 심리상담으로 전문적인 도움을 받아보는 게 좋아요.",
				},
				{
					minScore : 24,
					maxScore : Infinity,
					status : "심한 우울 상태",
					message : "누군가의 전문적인 도움이 필요해요! <br>네..지금 당신은 우울증 지수에서 가장 높은 단계에 속하는<strong> ‘심각하게 우울한 상태’</strong>입니다. <br>책읽기, 산책 등 일상적인 노력으로는 극복하지 못했다면 꼭 심리상담으로 전문적인 도움을 받으시길 추천해요.",
				}, ];
		...
		function updateQuestion() {
			...
			currentQuestion.answers.forEach(function(answer, index) {
				...
				listItem.classList.add("question", "question_"
						+ (currentQuestionIndex + 1), index + 1);
		...
		function updateProgress() {
			const progressWidth = ((currentQuestionIndex + 1) / questionList.length) * 100;
		...
		function showResultButton() {
			...
			resultButton
					.addEventListener(
							"click",
							function() {
								const channelQuestionDiv = document
										.getElementById("channel-question");
								const channelFinishDiv = document
										.getElementById("channel-finish");
								const finishPoint = document
										.getElementById("finish-point");
								const finishPoint_status = document
										.getElementById("finish-point-content");
								const finishContent = document
										.getElementById("finish-content");

								channelQuestionDiv.style.display = "none";
								channelFinishDiv.style.display = "block";

								const status = getStatusFromScore(totalScore);
								finishPoint.innerHTML = "<span>" + totalScore
										+ "</span>점";
								finishPoint_status.textContent = status.status;
								finishContent.innerHTML = getMessageFromStatus(status.status);

								if (status.status === "중한 우울 상태"
										|| status.status === "심한 우울 상태") {
									const counselingButton = document
