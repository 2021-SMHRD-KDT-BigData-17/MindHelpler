              ...
              <div class="signin-signup">
                <form action="${cpath}/CounLogin" class="sign-in-form">
                  <div class="input-field">
                    ...
                    <input type="text" placeholder="Username" id="counselorEmail" name="counselorEmail" />
                  </div>
                  <div class="input-field">
                ...
                <form action="${cpath}/CounSignUp" method="post" class="sign-up-form">
                  <div class="input-field">
                    <i class="fas fa-user"></i>
                  ...
                  <div class="input-field">
                    ...
                    <input type="text" placeholder="specialized field" />
                  </div>
                  <input
                    type="submit"
                    class="btn"
            ...
            <div class="panels-container">
              <div class="panel left-panel">
                <div class="login_content">
                  <h3>환영합니다.</h3>
                  <span>이곳은 상담사님들을 위한 페이지입니다.</span>
                  <p>업계 최고의 대우를 위해 노력하겠습니다.</p>
